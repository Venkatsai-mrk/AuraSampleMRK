({
    ...
    onNewMedicationActive: function(component, event) {
        ...
        component.set("v.ShowCustomMedication", true);
        
        
    },
    
    //Set rows from TAPER tab
    ...
    handleReviewOrder: function(component, event, helper) {
        console.log('INSIDE OPEN REVIEW');
      ...
      /*  var uniqueObjs = {};
        ...
        if($A.util.isEmpty(finalDataToSend)){
            ...
            //  console.log('TREE ' + JSON.stringify(component.get("v.selected")));
            component.set("v.openReviewOrder", true);
        }
        
        
    },
    handleHideCustomMedication :function(component, event, helper) {
        component.set("v.selTabId",'prn'); 
        component.set("v.ShowCustomMedication",false); 
