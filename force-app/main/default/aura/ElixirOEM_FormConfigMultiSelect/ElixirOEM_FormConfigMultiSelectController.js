({
    ...
    doInit : function( component, event, helper ) {
        if(component.get("v.countOfAlreadySelectedValues")){
           component.set("v.isEditInitialted",true); 
        }
        if(component.get("v.isEditInitialted")){
             component.set("v.searchString",component.get("v.countOfAlreadySelectedValues") + ' options selected');
        }
        else {
