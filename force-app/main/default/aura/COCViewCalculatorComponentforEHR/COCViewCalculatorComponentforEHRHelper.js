({
    calculatedTotalContractedPriceForEachProcedure : function(component, event, helper,dataArray) {
        ...
        for(var key in dataArray){
            if(!$A.util.isUndefinedOrNull(dataArray[key].Unit) && !$A.util.isUndefinedOrNull(dataArray[key].cPrice)){
                ...
                var a = parseInt(dataArray[key].Unit);
                var b = parseInt(dataArray[key].cPrice);
                dataArray[key].totalContractedPrice = a*b;  
            }
                else if(!$A.util.isUndefinedOrNull(dataArray[key].cPrice)) {
                    dataArray[key].Unit = 1;  
                    var c = parseInt(dataArray[key].Unit);
                    var d = parseInt(dataArray[key].cPrice);
                    dataArray[key].totalContractedPrice = c*d;  
                }
                    else if($A.util.isUndefinedOrNull(dataArray[key].cPrice && $A.util.isUndefinedOrNull(dataArray[key].cPrice))) {
                        dataArray[key].Unit = 1;  
                        dataArray[key].cPrice = 0;//changed by Avani Jain
                        var e = parseInt(dataArray[key].Unit);
                        var f = parseInt(dataArray[key].cPrice);
                        dataArray[key].totalContractedPrice = e*f;  
                    }
        }
    },
    ...
    calculationInHelper: function(component){
        ...
        var patiResponsibility = 0;
        var coInsurance = 0;
        var remainigDeductible = 0; 
        var oopMax = 0;
        if(parentNumber.length >= 1) {
            ...
            coInsurance = parseInt(parentNumber[0].ElixirSuite__Deduc_inNtwk_Clientperc__c);
            console.log('coInsurance----' + coInsurance);
            
            remainigDeductible = parseInt(parentNumber[0].ElixirSuite__in_network_total__c);
            console.log('remainigDeductible----' + remainigDeductible);
            
            oopMax = parseInt(parentNumber[0].ElixirSuite__out_of_network_outOfPocket_total__c);
            ...
            if(procTotal < remainigDeductible) {
                ...
                patiResponsibility = remainigDeductible + remaininSecPart;
                ...
                patiResponsibility = remaininSecPart;
                console.log('patiResponsibility----' + patiResponsibility);
        ...
        if(parentNumber.length >= 2) {
            ...
            coInsurance = parseInt(parentNumber[1].ElixirSuite__Deduc_inNtwk_Clientperc__c);
            console.log('coInsurance----' + coInsurance);
            
            remainigDeductible = parseInt(parentNumber[1].ElixirSuite__in_network_total__c);
            console.log('remainigDeductible----' + remainigDeductible);
            
            oopMax = parseInt(parentNumber[1].ElixirSuite__out_of_network_outOfPocket_total__c);
            console.log('oopMax----' + oopMax);
            ...
            if(patientResponsibility < remainigDeductible) {
                ...
                totalApplicableAmount = patientResponsibility - remainigDeductible;
                console.log('totalApplicableAmount----' + totalApplicableAmount);
        ...
        if(parentNumber.length >= 3) {
            ...
            coInsurance = parseInt(parentNumber[2].ElixirSuite__Deduc_inNtwk_Clientperc__c);
            console.log('coInsurance----' + coInsurance);
            
            remainigDeductible = parseInt(parentNumber[2].ElixirSuite__in_network_total__c);
            console.log('remainigDeductible----' + remainigDeductible);
            
            oopMax = parseInt(parentNumber[2].ElixirSuite__out_of_network_outOfPocket_total__c);
            console.log('oopMax----' + oopMax);
