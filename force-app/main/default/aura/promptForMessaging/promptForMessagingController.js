({
    ...
    deleteRecord : function(component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            if (state === "SUCCESS") {
                ...
                helper.navToMessageSubjectListView(component, event, helper);
            }
            else {
    ...
    UnarchiveMsg : function(component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            if (state === "SUCCESS") {
                var result = response.getReturnValue();
                console.log("success for unarchiveMsg",result);
                
                var toastEvent = $A.get("e.force:showToast");
                toastEvent.setParams({
                    "type": "success",
                    "title": "Message Unarchived Successful!",
    ...
    removeBookmarkMsg : function(component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            if (state === "SUCCESS") {
                var result = response.getReturnValue();
                console.log("success for remove bookmarkMsg",result);
                
                var toastEvent = $A.get("e.force:showToast");
                toastEvent.setParams({
                    "type": "success",
                    "title": "Message Bookmark Removed Successful!",
                    "message": "Message Bookmark is Removed successfully"
                });
                toastEvent.fire();
                component.set("v.showModal",false);    
