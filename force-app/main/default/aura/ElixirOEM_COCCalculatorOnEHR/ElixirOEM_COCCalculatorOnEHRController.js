({
    ...
    updateTotalContractedPrice : function(component, event, helper) {
        ...
        if(value.length>8){
            ...
            // toUpdateRecord.totalContractedPrice = toUpdateRecord.totalContractedPrice.toString();
            console.log('selectedProceduresData--'+JSON.stringify(selectedProceduresData));
