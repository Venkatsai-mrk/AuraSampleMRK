    ...
    setDefaultJSON : function(component,icdVal) {
        let defaultJSON = 
            {'codeCategorySelected' : '',
             ...
             'procedureEnd' : '',
             'placeOfService' : '',
             'careIdVal' : component.get("v.careId"),
             'unitsDuration' : '',
             'diagnosisPointer' : '',
             'preAuthCode' : component.get("v.preAuthCode"),
             //'claimType' : '',
...
setTypeOfPayment : function(component,event,recId) {
    ...
    setActiveCareEpisode : function(component,res) {
        console.log('setActiveCareEpisode res****upd1',res);
        if(res!=undefined){
    ...
    setClaimTypePicklistVal:  function(component, event, helper,res, defvalue) {
        ...
        for(let obj in defvalue){
            ...
            arr.push(sObj);
            component.set("v.defClaimTyp",obj); 
        }
        }else{
           var noneVal ={ 'value': "", 'label': "NONE" };
         arr.push(noneVal); 
        ...
        console.log('list val upd4***'+JSON.stringify(arr));
        component.set("v.recordDetail.claimType",component.get("v.defClaimTyp"));
