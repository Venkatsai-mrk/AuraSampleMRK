({
      ...
      //alert('recordId',+component.get("v.recordId"));
        ...
        if(component.get("v.ContactCentr")==true)
        {
            ...
            component.set('v.mycolumns', [
                ...
                {label: 'Patient Responsibility($)', fieldName: 'ElixirSuite__Patient_responsibility__c', type: 'text'},
                {label: 'Insurer Responsibility($)', fieldName: 'ElixirSuite__Insurer_Responsibility__c', type: 'text'},
    ...
    handleRowAction : function(component, event, helper) {
        ...
        console.log('Accc$$$$$$$$$$$$$$$',+event.getParam('row').Id);
