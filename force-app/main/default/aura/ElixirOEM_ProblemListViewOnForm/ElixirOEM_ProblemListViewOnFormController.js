        ...
        try{
           ...
           /* var workspaceAPI = component.find("workspace");
                ...
                if (state === "SUCCESS") {
                    ...
                    resp.forEach(function(column){                       
                       ...
                       /* console.log('ElixirSuite__Problem__r.Name '+JSON.stringify(column.ElixirSuite__Problem__r.Name));
                        ...
                        column['diagnosisType']= column.ElixirSuite__Problem__r.ElixirSuite__Diagnosis_Type__c; 
                        column['diagnosisId']= column.ElixirSuite__Diagnosis_Code__r.Id;     
 						//column['problemId']= column.ElixirSuite__Problem__r.ElixirSuite__Template_Problem__c; 
                        column['createdBy']= column.CreatedBy.Name;       
                    });*/
                    /*component.set('v.mycolumns', [                        
                        ...
                        for(let recSObj in csColArr){
                         ...
                         /*if(csColArr[recSObj] == "ProblemName"){
                               toAddCol.push({ label: mapOfApiAndLabel[csColArr[recSObj]], 
                                  fieldName: csColArr[recSObj], type:'button' ,typeAttributes:  {label: { fieldName: 'ProblemName' }, target: '_blank',name:'recLink',variant:'Base' }});    
                           console.log('sachin2');
            ...
            component.set("v.listDetails", resp);
             console.log('listDetails $$$'+JSON.stringify(component.get("v.listDetails")));
            component.set("v.loaded",true);
                        ...
                        deleteButton : function(component , helper , event){
                            ...
                            handleConfirmDialogNo : function(component, event, helper) {
                                ...
                                handleConfirmDialogYes : function(component, event, helper) {
                                    ...
                                    let deletedProblem = component.get("v.deletedProblem"); 
                                    deletedProblem.push(component.get("v.RowId"));
                                    component.set("v.deletedProblem",deletedProblem);   
