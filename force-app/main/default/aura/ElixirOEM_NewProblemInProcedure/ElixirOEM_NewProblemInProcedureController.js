    ...
    parentComponentEvent : function(component, event, helper) {
        try{
          ...
          //  recordProblem.diagnosisId = recsObj.diagnosisId;
            ...
            if(component.get("v.accountRelatedDiagnosisDataId").includes(recsObj.diagnosisId)){
                component.set("v.disableSave",true);
                var toastEvent = $A.get("e.force:showToast");
                toastEvent.setParams({
                    "title": "DIAGNOSIS ALREADY DEFINED FOR PATIENT",
                    "message": "Please select another diagnosis!",
                    "type" : "error"
                });
                toastEvent.fire();
            }
            ...
            if(component.get("v.recordDetail").diagnosisId != ''){
                ...
                action.setCallback(this, function(response) {
                    ...
                    if (state === "SUCCESS") {                
                        ...
                        helper.pushRecordAndIds(component, event, helper,response.getReturnValue()); 
