    ...
    setPickListName : function(component, selectedOptions) {
            ...
            if(selectedOptions.length < 1){
              ...
              //  component.set("v.selectedLabel", selections.slice(0, -1));
                    ...
                    // var abc= component.get("v.selecVal");
                    var abc = component.get("v.selectedLabelDuplicate");
                    if($A.util.isUndefinedOrNull(abc)){
                   abc = '';
               }
                    var jj = abc + selections1 ;
                    component.set("v.selectedLabelDuplicate" ,jj);
    },
       ...
       if(selectedOptions.length < 1){
           ...
           selectedOptions.forEach(option => {
             ...
             //  component.set("v.selectedLabel", selections.slice(0, -1));
                   ...
                   if($A.util.isUndefinedOrNull(duplicateVal)){
                   duplicateVal = '';
               }
               var selections1 = '';
