({
    myAction: function(component, event, helper) {	
        ...
        if(component.get("v.typeOfNote") == 'Problem'){
            var selectedTemp = column['problemNote'];
            component.set("v.problemNoteValue",selectedTemp);
            component.set("v.myVal", selectedTemp);
        }
        if(component.get("v.typeOfNote") == 'Diagnosis'){
            var selectedTemp = column['diagnosisNote'];
            component.set("v.diagnosisNoteValue",selectedTemp);
            component.set("v.myVal", selectedTemp);
        }
        if(component.get("v.typeOfNote") == 'Procedure'){
            var selectedTemp = column['procedureNote'];
            component.set("v.procedureNoteValue",selectedTemp);
            component.set("v.myVal", selectedTemp);
        }
                                  ...
                                  if(event.getParams().noteType == 'Problem'){
                                      if(eventValue.Type == undefined){
                                          if(eventValue == 'Other'){
                                              ...
                                              medications.push({'Id': eventValue.Id, 'FieldName': eventValue.FieldName, 'Description': eventValue.Description , 'Edit': true});
                                          ...
                                          if(eventValue.Type.toLowerCase() == 'problems'){
                                              ...
                                              problemsToSave.push({'Id' : eventValue.Id, 'FieldName' : eventValue.FieldName, 'Description' : description, 'Edit': true});
