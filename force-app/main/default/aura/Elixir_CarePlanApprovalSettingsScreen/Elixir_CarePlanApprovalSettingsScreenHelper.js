    ...
    initHelperCallback : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) { 
            ...
            if (state === "SUCCESS") {
                ...
                console.log('approvalFor in careplan '+approvalFor);
                ...
                if(!$A.util.isEmpty(response.getReturnValue().numberOfApprovalLevels)){
                    var carePlanCount=response.getReturnValue().numberOfApprovalLevels[0].ElixirSuite__Care_Plan_Approval_Level_Count__c;
                    
                    if(approvalFor == 'Care Plan' && carePlanCount != null ){
                         numberOfApprovalLevels = carePlanCount;
                    }
