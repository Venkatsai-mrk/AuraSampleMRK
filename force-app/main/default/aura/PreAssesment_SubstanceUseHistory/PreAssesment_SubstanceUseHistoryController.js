({
    ...
    doInit: function(component, event, helper) {
        ...
        var action = component.get("c.PicklistFromSUH");
        action.setCallback(this,function(response){
            
            var data=response.getReturnValue();
            
            component.set("v.Substance",data[0]);
            
            component.set("v.Frequency",data[1]);
    ...
    Save: function(component, event, helper) {
       ...
       if (helper.validateRequired(component, event)) {
        ...
        component.set("v.SahList.ElixirSuite__Pre_assessment__c",Id);
        console.log('sah lkup id'+component.get("v.SahList.ElixirSuite__Pre_assessment__c"));
        console.log('recordId-->'+Id);
        console.log('contact list value'+JSON.stringify(component.get("v.SahList")))
           var action = component.get("c.saveSubsanceUseHistoryRecords");
    ...
    toastEvent.setParams({
        "type" : "Success",
        "title": "Success!",
        "message": "SUBSTANCE USE HISTORY ADDED SUCCESSFULLY!."
    });
    toastEvent.fire();
