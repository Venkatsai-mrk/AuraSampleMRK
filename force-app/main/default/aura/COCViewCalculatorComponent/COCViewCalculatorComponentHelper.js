    ...
    calculationInHelper: function(component, event, helper,dataArray){
        ...
        if(parentNumber.length >= 1) {
           if(component.get("v.value") == 'Use Co-pay for Calculations'){
            ...
            if(!$A.util.isUndefinedOrNull(parseInt(parentNumber[0].ElixirSuite__Deductible_Individual_Out_Plan_Network__c)))
            {
                remainigDeductible=0;
            }
            else
            {
                remainigDeductible = parseInt(parentNumber[0].ElixirSuite__Deductible_Individual_Out_Plan_Network__c);}
    
            console.log('remainigDeductible----' + remainigDeductible);
            if(!$A.util.isUndefinedOrNull(parseInt(parentNumber[0].ElixirSuite__out_of_network_outOfPocket_total__c))){oopMax=0;}
                                          else
        ...
        if(parentNumber.length >= 2) {
            ...
            var remainigDeductible = parseInt(parentNumber[1].ElixirSuite__Deductible_Individual_Out_Plan_Network__c);
            console.log('remainigDeductible----' + remainigDeductible);
        ...
        if(parentNumber.length >= 3) {
            ...
            var remainigDeductible = parseInt(parentNumber[2].ElixirSuite__Deductible_Individual_Out_Plan_Network__c);
            console.log('remainigDeductible----' + remainigDeductible);
