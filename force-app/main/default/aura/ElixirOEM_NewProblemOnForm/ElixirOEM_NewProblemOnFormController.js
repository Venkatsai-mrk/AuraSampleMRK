            ...
            if(component.get("v.recordDetail").diagnosisId != ''){
                ...
                action.setCallback(this, function(response) {
                    ...
                    if (state === "SUCCESS") {   
                        ...
                        helper.updateOnListView(component, event, helper,response.getReturnValue(),false);                        
                    }
                    else{
                        component.set("v.loaded",true); 
                        var errors = response.getError();
            ...
            if(component.get("v.recordDetail").diagnosisId != ''){
                ...
                action.setCallback(this, function(response) {
                    ...
                    if (state === "SUCCESS") {                
                        ...
                        let recIds = component.get("v.insertedProblem");
                        recIds.push(response.getReturnValue());                      
                        helper.updateOnListView(component, event, helper,response.getReturnValue(),true);                       
                    }
                    else{
                        component.set("v.loaded",true); 
                        var errors = response.getError();
