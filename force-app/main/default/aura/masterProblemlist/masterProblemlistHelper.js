({
    ...
    checkCareEpisodehelper:function(component , event , helper,patientId){ 
         console.log('checkCareEpisodehelper--patientId'+patientId);
        ...
        action.setCallback(this,function(response){
            if(response.getState()==="SUCCESS"){
                ...
                console.log('@@@@@@@@@@@@@@@@@@1111='+returnval);
                if(returnval==true){          
                    component.set("v.careModal",true);
                    component.set("v.heading",'Problem_Diagnosis_List');
                }else{                   
                    component.set("v.masterProblemlist",true);/*
             ...
             console.log('checkCareEpisodehelper--heading--'+component.get("v.heading"));  
            }
        });
        $A.enqueueAction(action);
    },
