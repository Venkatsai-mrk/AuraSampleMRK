...
import getDiagnosisCode from '@salesforce/apex/LabTestBundleController.getDiagnosisCode';

const columns = [
   { label: 'Diagnosis Name', fieldName: 'Name' }
];

//export default class AddmoreDiagnosis extends LightningElement {}
export default class Modal extends LightningElement {
    showModal = false;
    @track searchValue;
    @api selectedRows;
    @track count;
    //@api DaiId = '9999'; //'2701389'
    @api show() {
    ...
    handleSearch() {
        getDiagnosisCode({ searchKey: this.searchKey })
            .then((response) => {
                //var i = 0;
    ...
    getSelectedDiagnosisRecords() {
            ...
            if (this.selectedRows.length > 0) {
                ...
                this.showErrorToast('No Diagnosis Code Selected');
            }
        }       
}