...
const CONTAINER_HTML = `<div class="draw-annotation-wrapper" style="margin: auto auto;">
...
export default class DrawAnnotationCanvas extends LightningElement {
     ...
     */
    @api hideTools = false;
    @api _interactionMode = INTERACTION_MODE.FULL;
    get hideToolbar() {
    ...
    @api get currentCanvasPng() {
       // alert('dataurl');
        ...
        console.log('canvas is '+ this._canvas.toDataURL);
    ...
    async overrideBackgroundImage() {
        if (this._canvas && this._backgroundImage && this._backgroundImage != "") {
            this._loadingCanvas = true;

            // set canvas dimension to that of _backgroundImage

            // create a Image object to store _backgroundImage
            // then via this Image object we can get _backgroundImage's width and height
            const img = new Image();

            // wait until image gets loaded
            ...
            // scaled dimensions
            let maxWidth = this.template.querySelector(".draw-annotation-container").offsetWidth;
            let scaledWidth;
            let scaledHeight;
            ...
            if (img.width > maxWidth) {
                ...
                // x wide -> y height
                // z wide -> y/x * z height
                scaledHeight = Math.round((img.height/img.width) * maxWidth);
            }
            else {
            ...
            // after image is loaded set canvas dimensions to that of img dimensions
            ...
            this._canvas.setBackgroundImage(this._backgroundImage,
                ...
                {
                    // referred from- https://stackoverflow.com/questions/47010467/fit-the-background-image-to-canvas-size-with-fabric-js
